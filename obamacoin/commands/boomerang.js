...
var help = {
    usage: "<input>",
    desc: "Plays a video normally then backwards.",
    aliases: ["pingpong"]
}
...
var filterGraph1 = "[0:v]reverse[r];[0:v][r]concat[v];[0:a]areverse[r];[0:a][r]concat=n=2:v=0:a=1[a]"
var filterGraph2 = "[0:v]reverse[r];[0:v][r]concat"
