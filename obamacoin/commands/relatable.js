...
var help = {
    usage: "[time] <input>",
    desc: "Oh, WOW. That is relatable!<br>" +
    ...
    fetchInputFile(msg, args, allowedExts, (inputFile, ext) => {
        checkStream(inputFile, "Video", hasVideo => {
            ...
            checkStream(inputFile, "Audio", hasAudio => {
                ...
                var ffmpegArgs = ["-i", inputFile, "-i", "assets/relatable.mp4", "-filter_complex", filterGraph, "-preset", "ultrafast"];
                switch (ext) {
                    case "gif":
                    case "png":
                    case "jpg":
